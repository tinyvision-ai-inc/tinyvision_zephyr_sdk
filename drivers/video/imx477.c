...
#define IMX477_REG_MODEL_ID_MSB			0x0016
#define IMX477_REG_MODEL_ID_LSB			0x0017
#define IMX477_REG_MODE_SEL			0x0100
#define IMX477_REG_CSI_LANE			0x0114
#define IMX477_REG_DPHY_CTRL			0x0808
#define IMX477_REG_EXCK_FREQ_MSB		0x0136
#define IMX477_REG_EXCK_FREQ_LSB		0x0137
#define IMX477_REG_FRAME_LEN_MSB		0x0340
#define IMX477_REG_FRAME_LEN_LSB		0x0341
#define IMX477_REG_LINE_LEN_MSB			0x0342
#define IMX477_REG_LINE_LEN_LSB			0x0343
#define IMX477_REG_X_ADD_STA_MSB		0x0344
#define IMX477_REG_X_ADD_STA_LSB		0x0345
#define IMX477_REG_X_ADD_END_MSB		0x0348
#define IMX477_REG_X_ADD_END_LSB		0x0349
#define IMX477_REG_Y_ADD_STA_MSB		0x0346
#define IMX477_REG_Y_ADD_STA_LSB		0x0347
#define IMX477_REG_Y_ADD_END_MSB		0x034A
#define IMX477_REG_Y_ADD_END_LSB		0x034B

#define IMX477_REG_X_OUT_SIZE_MSB		0x034C
#define IMX477_REG_X_OUT_SIZE_LSB		0x034D
#define IMX477_REG_Y_OUT_SIZE_MSB		0x034E
#define IMX477_REG_Y_OUT_SIZE_LSB		0x034F

#define IMX477_REG_IMG_ORIENT			0x0101
#define IMX477_REG_BINNING_MODE			0x0900
#define IMX477_REG_BINNING_HV			0x0901

#define IMX477_REG_BINNING_WEIGHTING		0x0902
#define IMX477_REG_BIN_CALC_MOD_H		0x0176
#define IMX477_REG_BIN_CALC_MOD_V		0x0177

#define IMX477_REG_CSI_FORMAT_C			0x0112		//0x08-> 8 bit 0x0A-> 10bit 0xC ->12bit
#define IMX477_REG_CSI_FORMAT_D			0x0113

#define IMX477_REG_ANA_GAIN_GLOBAL_MSB		0x0204
#define IMX477_REG_ANA_GAIN_GLOBAL_LSB		0x0205

#define IMX477_REG_ANA_GAIN_GLOBAL1_MSB		0x00F0
#define IMX477_REG_ANA_GAIN_GLOBAL1_LSB		0x00F1
#define IMX477_REG_ANA_GAIN_GLOBAL2_MSB		0x00F2
#define IMX477_REG_ANA_GAIN_GLOBAL2_LSB		0x00F3
#define IMX477_REG_ANA_GAIN_GLOBAL3_MSB		0x00F4
#define IMX477_REG_ANA_GAIN_GLOBAL3_LSB		0x00F5

#define IMX477_REG_DIG_GAIN_GLOBAL1_MSB		0x00F6
#define IMX477_REG_DIG_GAIN_GLOBAL1_LSB		0x00F7
#define IMX477_REG_DIG_GAIN_GLOBAL2_MSB		0x00F8
#define IMX477_REG_DIG_GAIN_GLOBAL2_LSB		0x00F9
#define IMX477_REG_DIG_GAIN_GLOBAL3_MSB		0x00FA
#define IMX477_REG_DIG_GAIN_GLOBAL3_LSB		0x00FB

#define IMX477_REG_FINE_INTEGRATION_TIME_MSB	0x0200
#define IMX477_REG_FINE_INTEGRATION_TIME_LSB	0x0201
#define IMX477_REG_COARSE_INTEGRATION_TIME_MSB	0x0202
#define IMX477_REG_COARSE_INTEGRATION_TIME_LSB	0x0203

#define IMX477_REG_IVTPXCK_DIV			0x0301
#define IMX477_REG_IVTSYCK_DIV			0x0303

#define IMX477_REG_IOP_PREPLLCK_DIV		0x030D
#define IMX477_REG_IVT_PREPLLCK_DIV		0x0305
#define IMX477_REG_PLL_IVT_MPY_MSB		0x0306
#define IMX477_REG_PLL_IVT_MPY_LSB		0x0307
#define IMX477_REG_IOPPXCK_DIV			0x0309
#define IMX477_REG_IOPSYCK_DIV			0x030B

#define IMX477_REG_IOP_MPY_MSB			0x030E
#define IMX477_REG_IOP_MPY_LSB			0x030F
#define IMX477_REG_PLL_MULTI_DRV		0x0310

#define IMX477_REG_TEST_PATTERN_MSB		0x0600
#define IMX477_REG_TEST_PATTERN_LSB		0x0601
#define IMX477_REG_TP_RED_MSB			0x0602
#define IMX477_REG_TP_RED_LSB			0x0603
#define IMX477_REG_TP_GREENR_MSB		0x0604
#define IMX477_REG_TP_GREENR_LSB		0x0605
#define IMX477_REG_TP_BLUE_MSB			0x0606
#define IMX477_REG_TP_BLUE_LSB			0x0607
#define IMX477_REG_TP_GREENB_MSB		0x0608
#define IMX477_REG_TP_GREENB_LSB		0x0609
#define IMX477_REG_TP_X_OFFSET_MSB		0x0620
#define IMX477_REG_TP_X_OFFSET_LSB		0x0621
#define IMX477_REG_TP_Y_OFFSET_MSB		0x0622
#define IMX477_REG_TP_Y_OFFSET_LSB		0x0623
#define IMX477_REG_TP_WIDTH_MSB			0x0624
#define IMX477_REG_TP_WIDTH_LSB			0x0625
#define IMX477_REG_TP_HEIGHT_MSB		0x0626
#define IMX477_REG_TP_HEIGHT_LSB		0x0627
#define IMX477_REG_FRAME_BLANKSTOP_CTRL		0xE000 // whether to go out of HS and into LP mode while frame blank happen

#define IMX477_REG_PD_AREA_WIDTH_MSB		0x38A8
#define IMX477_REG_PD_AREA_WIDTH_LSB		0x38A9
#define IMX477_REG_PD_AREA_HEIGHT_MSB		0x38AA
#define IMX477_REG_PD_AREA_HEIGHT_LSB		0x38AB

#define IMX477_REG_FRAME_LENGTH_CTRL		0x0350
#define IMX477_REG_EBD_SIZE_V			0xBCF1
#define IMX477_REG_DPGA_GLOBEL_GAIN		0x3FF9

#define IMX477_REG_X_ENV_INC_CONST		0x0381
#define IMX477_REG_X_ODD_INC_CONST		0x0383
#define IMX477_REG_Y_ENV_INC_CONST		0x0385
#define IMX477_REG_Y_ODD_INC			0x0387


#define IMX477_REG_MULTI_CAM_MODE		0x3F0B
#define IMX477_REG_ADC_BIT_SETTING		0x3F0D

#define IMX477_REG_SCALE_MODE			0x0401
#define IMX477_REG_SCALE_M_MSbit		0x0404
#define IMX477_REG_SCALE_M_LSB			0x0405
#define IMX477_REG_SCALE_N_MSbit		0x0406
#define IMX477_REG_SCALE_N_LSB			0x0407

#define IMX477_REG_DIG_CROP_X_OFFSET_MSB	0x0408
#define IMX477_REG_DIG_CROP_X_OFFSET_LSB	0x0409
#define IMX477_REG_DIG_CROP_Y_OFFSET_MSB	0x040A
#define IMX477_REG_DIG_CROP_Y_OFFSET_LSB	0x040B
#define IMX477_REG_DIG_CROP_WIDTH_MSB		0x040C
#define IMX477_REG_DIG_CROP_WIDTH_LSB		0x040D
#define IMX477_REG_DIG_CROP_HEIGHT_MSB		0x040E
#define IMX477_REG_DIG_CROP_HEIGHT_LSB		0x040F

#define IMX477_REG_REQ_LINK_BIT_RATE_MSB	0x0820
#define IMX477_REG_REQ_LINK_BIT_RATE_LMSB	0x0821
#define IMX477_REG_REQ_LINK_BIT_RATE_MLSB	0x0822
#define IMX477_REG_REQ_LINK_BIT_RATE_LSB	0x0823

#define IMX477_REG_TCLK_POST_EX_MSB		0x080A
#define IMX477_REG_TCLK_POST_EX_LSB		0x080B
#define IMX477_REG_THS_PRE_EX_MSB		0x080C
#define IMX477_REG_THS_PRE_EX_LSB		0x080D
#define IMX477_REG_THS_ZERO_MIN_MSB		0x080E
#define IMX477_REG_THS_ZERO_MIN_LSB		0x080F
#define IMX477_REG_THS_TRAIL_EX_MSB		0x0810
#define IMX477_REG_THS_TRAIL_EX_LSB		0x0811
#define IMX477_REG_TCLK_TRAIL_MIN_MSB		0x0812
#define IMX477_REG_TCLK_TRAIL_MIN_LSB		0x0813
#define IMX477_REG_TCLK_PREP_EX_MSB		0x0814
#define IMX477_REG_TCLK_PREP_EX_LSB		0x0815
#define IMX477_REG_TCLK_ZERO_EX_MSB		0x0816
#define IMX477_REG_TCLK_ZERO_EX_LSB		0x0817
#define IMX477_REG_TLPX_EX_MSB			0x0818
#define IMX477_REG_TLPX_EX_LSB			0x0819

#define IMX477_REG_PDAF_CTRL1_0			0x3E37
#define IMX477_REG_POWER_SAVE_ENABLE		0x3F50

#define IMX477_REG_LINE_LEN_INCLK_MSB		0x3F56
#define IMX477_REG_LINE_LEN_INCLK_LSB		0x3F57

#define IMX477_REG_MAP_COUPLET_CORR		0x0B05
#define IMX477_REG_SING_DYNAMIC_CORR		0x0B06
#define IMX477_REG_CIT_LSHIFT_LONG_EXP		0x3100

#define IMX477_REG_TEMP_SENS_CTL		0x0138

#define IMX477_REG_DOL_HDR_EN			0x00E3
#define IMX477_REG_DOL_HDR_NUM			0x00E4
#define IMX477_REG_DOL_CSI_DT_FMT_H_2ND		0x00FC
#define IMX477_REG_DOL_CSI_DT_FMT_L_2ND		0x00FD
#define IMX477_REG_DOL_CSI_DT_FMT_H_3ND		0x00FE
#define IMX477_REG_DOL_CSI_DT_FMT_L_3ND		0x00FF
#define IMX477_REG_DOL_CONST			0xE013
